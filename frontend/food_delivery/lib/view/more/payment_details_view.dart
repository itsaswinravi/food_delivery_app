...
Padding(
                ...
                const SizedBox(
                  height: 15,
                    ...
                    SizedBox(
                      width:100 ,
                      height: 28,
                      child: RoundButton(title: 'Delete card',fontSize: 12, onPressed:(){},
 ...
 const SizedBox(
              ...
              Padding(
                padding: const EdgeInsets.symmetric( horizontal: 25),
                child:  RoundIconButton(title:"Add Another Credit/Debit Card", color: TColor.primary, fontSize:16,  icon: 'assets/img/add.png',onPressed: (){
