...
class _HomeViewState extends State<HomeView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(child: Padding(padding: const EdgeInsets.symmetric(vertical: 20),
      child: Padding(padding: const EdgeInsets.symmetric(horizontal: 20),child: Column(
        ...
        children: [
          ...
          Text("Good morning ${ServiceCall.userPayload[KKey.name]}", style: TextStyle(color: TColor.primaryText, fontSize: 20, fontWeight: FontWeight.w800),),
...
Row(children: [
 ...
 const SizedBox(height: 20,),
                     Padding(padding: const EdgeInsets.symmetric(horizontal: 20),
          child:RoundTextfield(hintText: "Search Food",controller: txtSearch,left: Container(alignment: Alignment.center,width: 30,
          child: Image.asset("assets/img/search.png", width: 20, height: 20,),),
           ...
           child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return CategoryCell(cObj:cObj,onTop: () {
 ...
 Padding(padding: const EdgeInsets.symmetric(horizontal: 20),
          ...
          viewAllTitleRow(title: " Most Popular ", onView: () {
           ...
           child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return MostPopularCell(mObj:mObj,onTop: () {
          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return RecentItemRow(rObj:rObj,onTop: () {
